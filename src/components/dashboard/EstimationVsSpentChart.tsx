import { teams, getTeamTotalHours, getTeamTotalEstimated } from "@/data/dashboardData";
...
export function EstimationVsSpentChart() {
  return (
      ...
      <div className="h-64">
        <ResponsiveContainer width="100%" height="100%">
          <BarChart data={data} margin={{ top: 5, right: 5, left: -15, bottom: 5 }}>
            ...
            />
            <Legend
              wrapperStyle={{ fontSize: "11px", color: "hsl(215, 15%, 52%)" }}
            />
